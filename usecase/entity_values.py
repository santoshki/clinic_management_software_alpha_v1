...
def patient_vitals_status(patient_record_data):
    ...
    try:
        ...
        vitals_status.extend((bp_status, pulse_rate_status, oxygen_level_status, temperature_level_status))
        return vitals_status
    except Exception as e:
        print("Exception occurred while computing vitals status values:", e)
